            ...
            <div class="container">
                ...
                <div id="single-project">
                    <div id="slidingDiv" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio01.png" alt="project 1" />
                        </div>
                        <div class="span6">
                    ...
                    <div id="slidingDiv1" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio02.png" alt="project 2">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv2" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio03.png" alt="project 3">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv3" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio04.png" alt="project 4">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv4" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio05.png" alt="project 5">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv5" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio06.png" alt="project 6">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv6" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio07.png" alt="project 7">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv7" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio08.png" alt="project 8">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv8" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Portfolio09.png" alt="project 9">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
            ...
            <div class="container">
                ...
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Team1.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="second-person">
                        <div class="thumbnail">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Team2.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="third-person">
                        <div class="thumbnail">
                            <img src="<?php echo base_url(); ?>assets/Pluton/images/Team3.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<?php echo base_url(); ?>assets/Pluton/images/Client1.png" class="centered" alt="client 1">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<?php echo base_url(); ?>assets/Pluton/images/Client2.png" class="centered" alt="client 2">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<?php echo base_url(); ?>assets/Pluton/images/Client3.png" class="centered" alt="client 3">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
            ...
            <div class="container centered">
                <div class="sub-section">
                    ...
                    <ul class="row client-slider" id="clint-slider">
                        <li>
                            <a href="">
                                <img src="<?php echo base_url(); ?>assets/Pluton/images/clients/ClientLogo01.png" alt="client logo 1">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo base_url(); ?>assets/Pluton/images/clients/ClientLogo02.png" alt="client logo 2">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo base_url(); ?>assets/Pluton/images/clients/ClientLogo03.png" alt="client logo 3">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo base_url(); ?>assets/Pluton/images/clients/ClientLogo04.png" alt="client logo 4">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo base_url(); ?>assets/Pluton/images/clients/ClientLogo05.png" alt="client logo 5">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo base_url(); ?>assets/Pluton/images/clients/ClientLogo02.png" alt="client logo 6">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo base_url(); ?>assets/Pluton/images/clients/ClientLogo04.png" alt="client logo 7">
                            </a>
                        </li>
                    </ul>
                </div>
