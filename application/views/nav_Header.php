<header class="header dark-bg">
  ...
  <!--logo start-->
  <a href="Dashboard" class="logo">REMONS <span class="lite"><b>ADMIN</b></span></a>
  <!--logo end-->
    ...
    <ul class="nav pull-right top-menu">
      ...
      <!-- <li id="task_notificatoin_bar" class="dropdown">
        ...
        <ul class="dropdown-menu extended tasks-bar">
          ...
          <li>
            <p class="blue">Tidak ada pesan</p>
          </li>
          <li>
            <a href="#">
              <div class="task-info">
      ...
      <li id="alert_notificatoin_bar" class="dropdown">
        ...
        <ul class="dropdown-menu extended notification">
          <div class="notify-arrow notify-arrow-blue"></div>
          <li>
            <p class="blue">Tidak ada Notifikasi</p>
          </li>
          <!-- <li>
            <a href="#">
      ...
      <li class="dropdown">
        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
          <span class="profile-ava">
              <img alt="" src="<?php echo base_url(); ?>assets/NiceAdmin/img/default-icon.png">
          </span>
        ...
        <ul class="dropdown-menu extended logout">
          ...
          <!-- <li>
            <a href="#"><i class="icon_clock_alt"></i> User</a>
          </li> -->
          <li>
            <a href="Ganti_Password"><i class="icon_info_alt"></i> Ganti Password</a>
          </li>
          <li>
            <a href="Login/doLogout"><i class="icon_key_alt"></i> Log Out</a>
          </li>
        </ul>
      </li>
